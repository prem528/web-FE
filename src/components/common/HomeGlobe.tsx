import WorldGlobe from "@/CustomComponents/worldGlobe";
  ...
  return (
    <section className="w-full pt-16 md:pt-28">
      <div className="mx-auto max-w-[1400px] py-12 md:py-20">
        ...
        <motion.div
          className="rounded-[32px] backdrop-blur-xl ring-1 ring-white/10 border border-slate-800 bg-white/5 shadow-[0_-20px_60px_-10px_rgba(0,0,0,0.5)] px-4 sm:px-8 lg:px-12 py-12 md:py-20"
        ...
        >
          <div className="flex flex-col lg:flex-row items-center gap-10">
            ...
            {/* RIGHT: Text content with stagger (same pattern as FinanceHero) */}
            <motion.div
