...
export default function HeroSection() {
  return (
<section className="relative overflow-hidden text-white bg-[url('/square.svg')] bg-black bg-cover px-10 -mt-30">
  <div className="relative max-w-8xl  mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-10 -mb-28 lg:gap-16 ">
    ...
    <div className="space-y-5 max-w-2xl">
      ...
      <p className="text-base sm:text-lg text-gray-300 max-w-lg ml-28">
        Real stories from real users — See how ION-MONITOR helps parents stay connected.
      </p>
    </div>
